                  ...
                  <div>
                    <ul>
                      ...
                      <li>
                        ...
                        <Link aria-disabled={true} href={`/projects/${slug}/histopathology`} className="block px-1  " prefetch={true}>
                          <div className={`flex flex-row  mt-4  mb-2 p-4  ${router === `/projects/${slug}/histopathology` ? "bg-navy-500 text-white" : "bg-navy-800 text-white"}  rounded-lg  rounded-r-3xl shadow-md dark:bg-gray-800 text-center items-center w-11/12 justify-center`}>
